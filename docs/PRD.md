...
#### 4.2-1 기업 투자 매력도 (대표 기업 스코어, 100점)

발굴 목록의 대표 점수는 실적 가속만 나타내는 원점수가 아니라, 산업·기업·가치를 함께 본
**기업 투자 매력도**다. 현재 가격은 이 점수에 넣지 않고 PRI와 최종 등급에서 별도로 반영한다(ADR 5).
...
대표 기업 점수만으로 최종 등급을 정하지 않는다. §4.4에서 PRI와 교차해 현재 가격까지 반영한다.
...
|---|---|---|---|
| **기업 점수 ≥ 75** | ★ **최우선** | ○ **관심** | △ **추격 주의** |
| **기업 점수 60~75** | ○ **관심** | · 관찰 | · 관찰 |
| **기업 점수 < 60** | · 관찰 | · 관찰 | ✕ 제외 |
...
| `/` | 성장 가속 / 매출 YoY 둔화+영익 YoY 가속 / 턴어라운드 / 기타 / 전 종목 분류, 시총 포함 다중 정렬 | 2 |
| `/watchlist` | 발굴 목록에서 선택한 관심 종목. 브라우저에 영구 저장 | 3 |
| `/matrix` | **2축 산점도** (X=기업 투자 매력도, Y=주가반영도). 사분면 색상 구분, 점 클릭 시 상세 | 3 |
...
2. **판정 카드** — 등급(★○△·) / **기업 투자 매력도 7축 스택 바** / 실적 원점수 A·B·C·D 감사값 /
