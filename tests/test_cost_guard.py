...
def _good_payload() -> dict:
    return {
        ...
        "growth_engine": {"drivers": ["물량 증가"], "structural_or_temporary": "structural",
                          "evidence": "e"},
        "value_chain": {"upstream": "원재료 공급", "company_role": "부품 생산",
                        "customers": "공개된 고객 없음", "global_chain": "최종 고객 미공개",
                        "recent_global_events": [], "search_limit": "공시 검색에서 확인되지 않음"},
        ...
        "price_position": {"verdict": "적정", "reason": "r", "price_history": "p",
                           "priced_in": ["a"],
                           "not_priced_in": ["b"]},
