                ...
                "properties": {
                    "event": {
                        ...
                        "description": "주가를 올릴 수 있는 구체적 사건. 종류에 제한 없다 — "
                                       "성장 스토리 진전·CAPA 확장/증설 가동·지역(해외) 진출·"
                                       "신제품 발표/출시·신규 수주·고객사 승인 및 양산 진입·"
                                       "인증/허가·규제 정책 변화·전방 산업 사이클 전환·"
                                       "경쟁사 이탈·M&A/지분 투자·지수 편입·주주환원 등 무엇이든",
                    },
                    "verifiable_metric": {
                        "type": "string",
...
**트리거는 발생 가능성이 있는 것을 전부 적는다.** 실적 발표와 신규 수주만
반복하지 마라. 아래 목록을 **하나씩 훑으면서** 이 회사에 해당하는 것이 있는지 확인하고,
있으면 전부 적어라:

- **성장 스토리 진전** — 회사가 내세운 성장 서사가 숫자로 확인되는 지점
- **CAPA 확장** — 증설 발표·착공·완공·가동 개시·가동률 상승
- **지역 진출** — 해외 법인/공장 설립, 신규 국가 수출 개시, 현지 인증 취득
- **신제품 발표** — 출시·양산 전환·매출 기여 시작
- **신규 수주** — 수주 공시, 수주잔고 증가, 장기공급계약
- **고객사 이벤트** — 고객 승인(퀄), 양산 진입, 고객사의 증설·신제품
- **인증·허가** — 규격 인증, 품목 허가, 임상 단계 진전
- **규제·정책** — 지원책, 관세, 표준 변경
- **전방 산업 사이클** — 업황 지표 전환, 가격 반등, 재고 소진
