...
EXPECTED_COLUMNS: tuple[tuple[str, str, str, str], ...] = (
    ...
    ("price_snapshots", "high_52w_drawdown_pct", "NUMERIC", "PRI P1 52주 신고가 대비 등락"),
    ("price_snapshots", "announcement_date", "DATE", "PRI 기준 최초 실적 발표일"),
    ...
    ("price_snapshots", "announcement_excess_return_pct", "NUMERIC", "PRI 실적 발표 후 시장·섹터 대비 초과수익"),
    ("price_snapshots", "per_current_ttm", "NUMERIC", "현재 TTM PER"),
    ("price_snapshots", "roe_est", "NUMERIC", "상세 화면의 네이버 올해 예상 ROE"),
    ("price_snapshots", "roe_next_est", "NUMERIC", "발굴 목록의 네이버 내년도 F.ROE"),
    ...
    ("price_snapshots", "earnings_revision_pct", "NUMERIC", "PRI 최근 90일 이익 전망 변화"),
    ("price_snapshots", "earnings_revision_price_gap_pct", "NUMERIC", "PRI 전망 변화 대비 주가 괴리"),
    ("price_snapshots", "valuation_reflection_pct", "NUMERIC", "PRI 밸류에이션 반영도"),
    ("price_snapshots", "relative_return_pct", "NUMERIC", "PRI 3·6·12개월 평균 상대수익률"),
    ("price_snapshots", "foreign_net_qty_5d", "BIGINT", "발표 후 5거래일 외국인 순매수량"),
    ("price_snapshots", "foreign_volume_5d", "BIGINT", "발표 후 5거래일 거래량"),
    ("price_snapshots", "foreign_net_ratio_5d", "NUMERIC", "PRI P4 발표 후 5거래일 외국인 수급"),
    ("price_snapshots", "rsi_14", "NUMERIC", "PRI P5 RSI(14)"),
