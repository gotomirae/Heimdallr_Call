...
from src.universe.sector_map import (
    ...
    SECTOR_ETF_THEMES,
    SECTOR_RULES,
    SEMICONDUCTOR_BACK_PROCESS_KEYWORDS,
    SEMICONDUCTOR_BACK_PROCESS_OVERRIDES,
    SEMICONDUCTOR_CONTEXT,
    SEMICONDUCTOR_EQUIPMENT_STANDALONE,
    SEMICONDUCTOR_FRONT_PROCESS_KEYWORDS,
...
def build() -> dict:
    ...
    return {
        ...
        "semiconductor_back_process_overrides": list(SEMICONDUCTOR_BACK_PROCESS_OVERRIDES),
        ...
        "notify": {
            ...
            "technical_post_announcement_correction_pct": constants.TECHNICAL_POST_ANNOUNCEMENT_CORRECTION_PCT,
            ...
            "technical_sma_gap_max_abs_pct": constants.TECHNICAL_SMA_GAP_MAX_ABS_PCT,
            "technical_rsi_strong_max": constants.TECHNICAL_RSI_STRONG_MAX,
            "technical_rsi_trend_days": constants.TECHNICAL_RSI_TREND_DAYS,
            "technical_price_max_age_calendar_days": constants.TECHNICAL_PRICE_MAX_AGE_CALENDAR_DAYS,
            "technical_min_daily_fetch_rate": constants.TECHNICAL_MIN_DAILY_FETCH_RATE,
        },
