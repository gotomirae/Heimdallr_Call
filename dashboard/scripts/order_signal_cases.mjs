...
const { deriveOrderDisclosureSignal, extractOrderDisclosureMetric, summarizeOrderDisclosure } = jiti(resolve(here, "..", "lib", "orderSignals.ts"));
...
process.stdout.write(JSON.stringify(cases.map((c) => c.summary
