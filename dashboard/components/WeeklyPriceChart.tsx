...
export default function WeeklyPriceChart({ points }: { points: WeeklyPriceRow[] }) {
  if (!points.length) return <p className="py-5 text-center text-sm text-slate-300">주간 종가를 아직 수집하지 않았다.</p>;
  return (
